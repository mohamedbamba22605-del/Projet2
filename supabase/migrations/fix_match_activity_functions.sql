-- Script SQL pour corriger les fonctions du système Match
-- Exécutez ce script dans l'éditeur SQL de Supabase

-- 1. Créer la table roles_supplementaires si elle n'existe pas
...
-- 2. Créer la table inscriptions_match si elle n'existe pas
...
-- 3. Créer les indexes si ils n'existent pas
